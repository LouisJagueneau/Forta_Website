                             ...
                             lg:w-1/2">
                                <div className=" bg-[#f7f7f7] px-10 py-6 rounded-sm">
                                    ...
                                    <form method='POST' action="/react/contact.php" className="text-black placeholder-black/20 font-poppins font-light flex flex-col gap-y-5">
                                        <input type="text" name="name" placeholder="Name" className="px-4 py-5  h-[48px] border border-black/10 focus:border-[#ec1c24] outline-none" />
                                        <input type="email" name="email" placeholder="Email" className="px-4 py-5  h-[48px] border border-black/10 focus:border-[#ec1c24] outline-none" />
                                        <input type="text" name="subject" placeholder="Subject" className="px-4 py-5  h-[48px] border border-black/10 focus:border-[#ec1c24] outline-none" />
                                        <textarea name="message" id="" placeholder="Type your message here ..." className="px-4 py-5  min-h-[150px] border border-black/10 focus:border-[#ec1c24] outline-none"></textarea>
                                        <input type="submit" value='Send' className="bg-[#ec1c24] text-white font-medium rounded-sm py-2" />
                                    </form>
                                </div>
                            </section>
                                    ...
                                    {contacts.map((contact) => (
                                        <div key={contact.name} className="flex items-stretch gap-5 mb-8 lg:mb-16">
                                            ...
                                            <div className="font-poppins flex flex-col justify-center">
                                                <span className="text-black/60 capitalize">{contact.name}</span>
