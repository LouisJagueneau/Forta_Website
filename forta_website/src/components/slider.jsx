    ...
    return (
        <div className="w-full flex flex-col justify-center items-center">
            ...
            <Swiper
                ...
                autoplay={{ delay: 3000 }}
                className="max-w-[250px] md:max-w-screen-xl w-full shadow-md" // largeur max + responsive
                breakpoints={{
            ...
            >
                {slides.map((slide, index) =>
                    <SwiperSlide className=' rounded-sm shadow-md' key={index}>
                        <div className="flex flex-col p-5 border-[1px] border-[#ADADAD] border-b-[#ec1c24] border-b-3 rounded-sm bg-white h-[400px]">
